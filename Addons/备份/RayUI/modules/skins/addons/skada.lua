...
local function SkinSkada()
	...
	function EmbedSkada()
		if #windows == 1 then
			EmbedWindow(windows[1], windowWidth, 180/bars - barSpacing, 180, "BOTTOMRIGHT", R.UIParent, "BOTTOMRIGHT", -15, 30)
		elseif #windows == 2 then
			EmbedWindow(windows[1], windowWidth*3/4, 180/bars - barSpacing, 180, "BOTTOMRIGHT", R.UIParent, "BOTTOMRIGHT", -15, 30)
			EmbedWindow(windows[2], windowWidth*3/4, 180/bars - barSpacing, 180, "BOTTOMRIGHT", R.UIParent, "BOTTOMRIGHT", - windowWidth*3/4 - 25, 30)
		end
	end
