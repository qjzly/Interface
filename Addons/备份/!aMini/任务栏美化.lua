...
local StripesThin = "Interface\\Addons\\!aMini\\Media\\StripesThin"
local Texture = "Interface\\Addons\\!aMini\\Media\\statusbar"
local glowTex = "Interface\\Addons\\!aMini\\Media\\glowtex"
local gloss = "Interface\\Addons\\!aMini\\Media\\gloss"
...
local CreateSDD = function(parent, size, r, g, b, alpha, offset)
	...
	sd:SetPoint("TOPLEFT", -4, 4)--("TOPLEFT", parent, -sd.size - 0 - sd.offset, sd.size + 0 + sd.offset)
	sd:SetPoint("BOTTOMRIGHT", 4, -4)--("BOTTOMRIGHT", parent, sd.size + 0 + sd.offset, -sd.size - 0 - sd.offset)
