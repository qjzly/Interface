...
button = makeButton("OpenAllButton", "取信", 60, 25, -60, -399)
button:SetScript("OnClick", openAll)
button:SetScript("OnEvent", onEvent)
button2 = makeButton("OpenAllButton2", "取钱", 60, 25, 10, -399)
button2:SetScript("OnClick", openAllCash)

button:SetScript("OnEnter", function()
	GameTooltip:SetOwner(button, "ANCHOR_RIGHT")
	GameTooltip:AddLine(string.format("%d 取信", GetInboxNumItems()), 1, 1, 1)
	GameTooltip:Show()
end)
